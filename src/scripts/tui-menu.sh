...
while :; do
    choice=$($DIALOG --stdout --clear --backtitle "$FOOTER" --title "ProbeOS" --menu "Hardware Inspection & Diagnostics" 26 84 19 \
        1 "System Summary" 2 "CPU" 3 "Memory" 4 "Motherboard / Firmware" 5 "PCI Devices" 6 "USB Devices" 7 "Graphics" 8 "Storage" 9 "Network" 10 "Network / Web UI" 11 "Sensors / Power" 12 "Windows / OEM License" 13 "Benchmarks" 14 "Export Report" 15 "Shell" 16 "Reboot" 17 "Power Off") || exit 0
    case "$choice" in
        ...
        12) windows_info ;; 13) benchmark_menu ;; 14) export_report ;;
